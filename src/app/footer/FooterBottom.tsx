...
function FooterBottom() {
    return (
        <div className="border-t-[1px] border-milk pt-[20px] flex flex-wrap">
            <div className="max-sm:w-full lg:flex-1">
                <ul className="text-milk max-sm:justify-center font-semibold *:opacity-75 transition delay-[30] flex flex-wrap pl-0 mb-0 list-none">
            ...
            <div className="max-md:w-full max-sm:mt-2 text-center">
                <Link to={ "/policy" }
